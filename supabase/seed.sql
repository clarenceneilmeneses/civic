...
('batangas-city-opens-new-youth-center', 'Batangas City Opens New Youth Innovation Center',
 ...
 'https://picsum.photos/seed/youthcenter/1200/675', 'news', 'Youth', 'published', now() - interval '2 days'),
('coastal-cleanup-drive-2026', 'Over 1,200 Volunteers Join Coastal Cleanup Drive',
 ...
 'https://picsum.photos/seed/coastal/1200/675', 'news', 'Environment', 'published', now() - interval '5 days'),
('free-wifi-plazas-expansion', 'Free Public Wi-Fi Now Live in 15 Barangay Plazas',
 ...
 'https://picsum.photos/seed/wifi/1200/675', 'news', 'Infrastructure', 'published', now() - interval '9 days'),
('sk-federation-leadership-summit', 'SK Federation Holds City-Wide Leadership Summit',
 ...
 'https://picsum.photos/seed/sksummit/1200/675', 'news', 'Youth', 'published', now() - interval '14 days'),
('public-market-modernization', 'Public Market Modernization Enters Phase 2',
 ...
 'https://picsum.photos/seed/market/1200/675', 'news', 'Infrastructure', 'published', now() - interval '20 days'),
('scholarship-applications-record', 'City Scholarship Program Receives Record 4,000 Applications',
 ...
 'https://picsum.photos/seed/scholar/1200/675', 'news', 'Education', 'published', now() - interval '26 days'),
('advisory-hazard-drill', 'ADVISORY: City-Wide Earthquake Drill on the 25th',
 ...
 'https://picsum.photos/seed/drill/1200/675', 'announcement', 'Advisory', 'published', now() - interval '1 day'),
('advisory-business-permit-renewal', 'Business Permit Renewal Extended Until End of the Month',
 ...
 'https://picsum.photos/seed/permit/1200/675', 'announcement', 'Advisory', 'published', now() - interval '3 days');
...
('inter-barangay-basketball-2026', 'Inter-Barangay Youth Basketball League',
 ...
 'https://picsum.photos/seed/bball/1200/675', 'Sports', now() + interval '12 days', now() + interval '40 days',
...
('himig-batangan-songwriting-camp', 'Himig Batangan: Youth Songwriting Camp',
 ...
 'https://picsum.photos/seed/songcamp/1200/675', 'Arts', now() + interval '18 days', now() + interval '20 days',
...
('youth-leaders-bootcamp', 'Batangueño Youth Leaders Bootcamp',
 ...
 'https://picsum.photos/seed/bootcamp/1200/675', 'Leadership', now() + interval '9 days', now() + interval '10 days',
...
('mangrove-planting-wawa', 'Mangrove Planting at Wawa Estuary',
 ...
 'https://picsum.photos/seed/mangrove/1200/675', 'Volunteering', now() + interval '6 days', now() + interval '6 days',
...
('city-college-scholarship-orientation', 'City College Scholarship: Application Orientation',
 ...
 'https://picsum.photos/seed/scholarorient/1200/675', 'Scholarships', now() + interval '4 days', now() + interval '4 days',
...
('sk-budget-hackathon', 'SK Open Data Day: Budget Transparency Hackathon',
 ...
 'https://picsum.photos/seed/hackathon/1200/675', 'SK Programs', now() + interval '25 days', now() + interval '26 days',
...
('mural-arts-festival', 'Sining Kalye: Youth Mural Arts Festival',
 ...
 'https://picsum.photos/seed/mural/1200/675', 'Arts', now() + interval '32 days', now() + interval '34 days',
...
('first-aid-certification', 'Free First Aid & BLS Certification for Youth Volunteers',
 ...
 'https://picsum.photos/seed/firstaid/1200/675', 'Volunteering', now() + interval '15 days', now() + interval '15 days',
